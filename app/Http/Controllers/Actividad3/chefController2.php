...
class chefController2 extends Controller
{
    //
...
public function update(Request $request, $id)
{
    ...
    //     $response = Http::put('http://25.62.178.77:8000/api/chef/update/'.$id,
    //     [
...
{
    // if($request->ip()=="25.63.10.104"){
    //     $response = Http::delete('http://25.62.178.77:8000/api/chef/delete/'.$id);
    // }
$chef = Chef::find($id); 
if ($chef){
    $chef ->status = false; 
